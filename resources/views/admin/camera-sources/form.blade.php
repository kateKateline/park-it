<x-layouts.admin :title="$mode === 'create' ? 'Tambah Sumber Kamera - Admin' : 'Edit Sumber Kamera - Admin'">
    <div class="mx-auto max-w-5xl p-6">
        @include('partials.topbar', [
            ...
            'subtitle' => 'Kelola data sumber kamera dengan tampilan yang konsisten.',
        ])
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input name="stream_url"
                               ...
                               class="mt-1 w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-base outline-none focus:border-slate-900 focus:ring-2 focus:ring-slate-900/10 font-mono"
                               required />
